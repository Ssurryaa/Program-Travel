...
class developer {
    public void develop() {
        System.out.println("Developer Program Travel :");
    }
}

class name extends developer {
    public void develop() {
        System.out.println("I Gusti Made Agung Ary Surya Persada");
    }
}

class nim extends developer {
    public void develop() {
        System.out.println("2005551151\n");
    }
}
...
class Main {
    ...
    static void header(){
        header myObj = new header();
        myObj.setName("Program Travel");
